...
{{2-3}} Sterne sind im Grunde nichts Anderes als sehr ferne Sonnen. Wie unsere Sonne sind Sterne riesige, heiße Gasbälle. Sterne leuchten selber, weil sie im Inneren gewaltige Mengen an Energie freisetzen. Dort ist es viele Millionen Grad heiß, und auch an der Oberfläche herrschen noch Temperaturen von mehreren tausend Grad. Diese Hitze strahlen die Sterne dann in Form von sichtbarem Licht ab, aber auch in Form von Wärme anderer unsichtbarer Strahlung.
...
![bg right:22% w:350 Voegel haben Federn](image_small/02_Vogel_federn.png)
...
![bg right:22% w:350 Kurdistan kein Staat](image_small/03_Kurdistan.png)
...
![bg right:22% w:350 große Tiere](image_small/04_groesste_Tiere.png)
...
![bg right:22% w:350 Weihnachtsmann](image_small/05_Glaube_Weihnachtsmann.png)
...
![bg right:22% w:350 Brille](image_small/06_Erfindung_Brille.png)
...
![bg right:22% w:350 kompliziert](image_small/07_Komplizierte_Welt.png)
...
![bg right:22% w:350 Marathon](image_small/08_Marathon.png)
...
![bg right:22% w:350 Chamäleon](image_small/09_spiegel_chamaeleon.png)
...
![bg right:22% w:350 Schwein](image_small/10_Schwein_pfeift.png)
...
![bg right:22% w:350 Flugzeug](image_small/11_Flugzeug_kaelter.png)
...
![bg right:22% w:350 Sprachen](image_small/12_Sprachen.png)
...
![bg right:22% w:350 Computerspielen](image_small/13_Verlangen_Computerspielen.png)
...
![bg right:22% w:350 sterben](image_small/14_Sterben_alte_Leute.png)
...
![bg right:22% w:350 Hautfarben](image_small/15_Hautfarben.png)
...
![bg right:22% w:350 Amnesie](image_small/16_Kinder_Amnesie.png)
...
Als Vergleich: Du hast etwas abgelegt, findest es aber nicht wieder. Dies sind drei verschiedene Theorien, warum du dich an Dinge, die du sehr früh erlebt hast, nicht erinnern kannst. Welche jetzt richtig ist oder ob alle drei zu bestimmten Teilen stimmen, weiß man noch nicht.
...
![bg right:22% w:350 Fliege im Auto](image_small/17_Fliege_im_Auto.png)
...
![bg right:22% w:350 ausgestorbene Tiere](image_small/18_ausgestorbene_Tiere.png)
...
![bg right:22% w:350 Szuizid](image_small/19_Warum_Suizid.png)
...
![bg right:20% w:350 IQ](image_small/20_hoechster_IQ.png)
...
![bg right:22% w:350 Kinder 1890](image_small/21_Kinder_1890.png)
...
![bg right:22% w:350 Werwölfe](image_small/22_Werwoelfe.png)
...
![bg right:22% w:350 Geld](image_small/23_Erfindung_Geld.png)
...
![bg right:22% w:350 Entstehung der Erde](image_small/24_Entstehung_Erde.png)
...
![bg right:22% w:350 Erddrehung](image_small/25_Erddrehung_nicht_spuerbar.png)
...
![bg right:22% w:350 Wasser auf der Erde](image_small/26_Wasser_auf_Erde.png)
...
![bg right:22% w:350 Unterwasser atmen](image_small/27_atmen_unter_Wasser.png)
...
![bg right:22% w:350](image_small/28_ausserhalb_Universum.png)
...
![bg right:22% w:350](image_small/29_Gravitation.png)
...
![bg right:22% w:350](image_small/30_Warum_brennen_Gegenstaende.png)
...
> Dr. rer. nat. Dirk Wübben ist Lehrer an einer Schule in Ostfriesland. Biologin Anja Wübben ist Referentin für den Wissenstransfer aus den Hochschulen in die Schulen der Region Ems/Weser.
...
![bg right:22% w:350](image_small/31_Waerme_aufsteigen.png)
...
![bg right:22% w:350 Weltall](image_small/32_warum_Weltall.png)
...
Aus dem physikalischen Blickwinkel wird gefragt, wie etwas funktioniert, wohingegen biologische Fragestellungen die Ursache einbeziehen, sie fragen z. B. **Warum** konnte in der Evolution das Streifenmuster der Zebras entstehen? Biologen beantworten Fragen nach der Ursache z. B. mit der Funktion: Die Streifen im Fell irritieren Mücken, sie schützen vor Insektenstichen. Man kann erklären, welche Bedeutung ein Teil (die Streifen) für das Ganze (das Zebra) hat.
...
![bg right:22% w:350 Schallwellen](image_small/33_Schall_Fledermaeuse.png)
...
![bg right:22% w:350 Windstärke](image_small/34_Windstaerke.png)
